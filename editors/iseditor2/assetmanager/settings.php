...
$sBaseVirtual0= substr($srv_settings['url_files'], 0, strlen($srv_settings['url_files']) - 1);  //Assuming that the path is http://yourserver/Editor/assets/ ("Relative to Root" Path is required)
