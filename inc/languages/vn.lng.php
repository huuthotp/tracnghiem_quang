...
// ----------------------------------------------------------------------
// Branding:
$lngstr['branding']['top_logo'] = '<img src="images/logo.jpg" width=98 height=90>';
$lngstr['branding']['btm_sign'] = 'Copyright &copy; Bùi Đức Quang 2016. All Rights Reserved.';
// Sign in page:
$lngstr['page_signin_box_intro'] = '';

// Non-customizable (it is not recommended to customize this data):
// ----------------------------------------------------------------
$lngstr['branding']['powered_by'] = 'Trắc nghiệm Toán Học v'.IGT_VERSION.'';
// General:
...
$lngstr['page-register']['successful'] = 'Chào "%s" ! Bạn đã đăng kí thành công. <br>Chúng tôi rất vui khi bạn tham gia học tập Online trên http://lophoctoan.net. <br>
Chúc bạn học gỏi, Thành công trên con đường học vấn. <br>
Nếu có gì thắc mắc hay góp ý bạn có thể liên lạc với :<br>
<font color=blue>Admin: Bùi Đức Quang, Email: buiducquang@gmail.com </font>';
...
$lngstr['page_signin_box_lostpassword_intro'] = '<b>Bạn đã có tài khoản? </b> Nếu bạn <a href="lostpassword.php">quên mật khẩu</a>, Chúng tôi sẽ gửi lại qua mail của bạn.<br><br><b>';
...
$lngstr['install_page3_description'] = '<p>Xin cấu hình hình cơ sở dữ liệu ở đâu . Mạng(lưới) được kiểm tra dữ liệu sẽ được cất giữ. Cơ sở dữ liệu này được phải đã có được tạo ra và một username và mật khẩu được tạo ra để truy nhập nó.';
...
Cảm ơn bạn đăng ký Với LOPHOCTOAN.NET (http://lophoctoan.net).
...
http://lophoctoan.net/account.php?action=activate&userid=[USER_ID]&checkword=[USER_CHECKWORD]
